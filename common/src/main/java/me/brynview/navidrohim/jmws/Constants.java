...
public class Constants {
    ...
    public static final String VERSION = "1.1.5-1.21.6";

    public static final List<String> forgeModLoaders = List.of("NeoForge");
    ...
    public static final String JourneyMapVersionString = "1.21.6-6.0.0-beta.52";
}
